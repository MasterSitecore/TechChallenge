...
namespace TechChallenge.Project.Services
{
    ...
    {
        private ConvertToWordHelperModel numbersToWordsModel;
        private DetailsModel result;

        public ConverterService()
        {
            numbersToWordsModel = new ConvertToWordHelperModel();
            result = new DetailsModel();
        }
        ...
        private DetailsModel ConvertNumberToWords(int value)
        {
            //Ones
            if (value <= 9)
            {
