...
using TechChallenge.Project.Controllers;
...
namespace TechChallenge.Project.Tests.Controllers
{
    [TestClass]
    public class WordConverterControllerTest
    {
        private DetailsModel dataModelTest;
        private WordConverterController converterControllerTest;

        [TestInitialize]
        public void Initialize_ConverterControllerTest()
        {
            dataModelTest = new DetailsModel();

            converterControllerTest = new WordConverterController();
        ...
        public void PassModel_AsNull_MustThrowExceptionWithErrorMessage()
        {
            ...
            // Act
            converterControllerTest.ConvertNumberToWords(dataModelTest);
        ...
        {
            // Arrange
            dataModelTest.Name = "Harpreet Virk";
        ...
        public void WithOneDigit_WholeNumber_MustReturnNumbersAsWords()
        {
            ...
            // Act
            var result = converterControllerTest.ConvertNumberToWords(dataModelTest);
            var dataModelResult = result as OkNegotiatedContentResult<DetailsModel>;

            // Assert
            Assert.IsTrue(dataModelResult.Content.Name.Equals("Harpreet Virk"));
